    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, bookService.readBook(id)];
                case 2:
                    book = (_a.sent());
                    return [2 /*return*/, res.status(httpStatus.OK).send(book)];
                case 3:
                    error_1 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, bookService.readAllBook()];
                case 1:
                    allBooks = (_a.sent());
                    return [2 /*return*/, res.status(httpStatus.OK).send(allBooks)];
                case 2:
                    error_2 = _a.sent();
                    return [2 /*return*/, res.sendStatus(httpStatus.INTERNAL_SERVER_ERROR)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, bookService.updateBook(id, updatedBook)];
                case 2:
                    _a.sent();
...
export function howManyBooksWereDone(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var booksDone, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, bookService.howManyBooksWereDone()];
                case 1:
                    booksDone = _a.sent();
                    return [2 /*return*/, res.status(httpStatus.OK).send(booksDone)];
                case 2:
                    error_6 = _a.sent();
                    return [2 /*return*/, res.sendStatus(httpStatus.INTERNAL_SERVER_ERROR)];
                case 3: return [2 /*return*/];
